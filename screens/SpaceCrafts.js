...
import { Text, View, FlatList, Image, ImageBackground, TouchableOpacity, StyleSheet, Alert, Platform, StatusBar, SafeAreaView,  } from 'react-native';
    ...
    renderItem=({item})=>{
        return(
          <View style={{ borderRadius: 5,
            ...
            <Text style={{ fontWeight: 'bold', fontSize: 20, color: 'purple' }}>{item.agency.name}</Text>
